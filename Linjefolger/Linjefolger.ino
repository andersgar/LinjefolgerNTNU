...
float turnConf = 0.75; //svingekonstant 1
float turnConf2 = 1.8; //svingegonstant 2
int proxConf = 10; //prox-baseline
...
void loop() {
  ...
  if (car.data[PROXIMITY].flag) {//Proxplotter
    ...
    if(proDATA >= proxConf){
     // triangle(DOWN);  for å automatisk snu ved prox
    }
  }
 
  if (car.data[ENCODERS].flag) {//Speedplotter
